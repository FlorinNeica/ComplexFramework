...
public class SeleneseTest {
	...
	public void setup() {
		...
		driver = BrowserSession.getInstance()
				.getWebDriver();

		acceptCookies(); // se poate scoate aceasta metoda!
	}
	...
	private void acceptCookies() {
		...
		if (driver.findElements(btnAcceptCookies)
				.isEmpty()) {
			return;
		}
		...
		driver.findElement(btnAcceptCookies)
				.click();
	}
